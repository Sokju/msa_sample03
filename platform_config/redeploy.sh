...
kubectl delete -f msa3-svc-ui/deployment.yml
...
docker build -t 192.168.100.102:5000/msasmp03/msa3-svc-ui:1.0    msa3-svc-ui/.
...
docker push 192.168.100.102:5000/msasmp03/msa3-svc-ui:1.0
...
kubectl apply -f <(istioctl kube-inject -f msa3-svc-ui/deployment.yml)

kubectl rollout restart deployment/msa3-svc-order
kubectl rollout restart deployment/msa3-svc-member
kubectl rollout restart deployment/msa3-svc-ui
